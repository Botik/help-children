$(document).ready(function(){
    if ($(window).width() > 768) {
        ...
        .fromTo('.fixed-animation-block .right-half .elem11',{opacity:0,scale:0.5},{opacity:1,scale:1,duration:1},'stage3+=7')
        .to('.fixed-animation-block .right-half .elem11',{opacity:0,scale:0.5,duration:1},'stage3+=8.5')
        ...
        .fromTo('.fixed-animation-block .right-half .elem6',{opacity:0,scale:0.5},{opacity:1,scale:1,duration:1},'stage3+=9.5')
        .to('.fixed-animation-block .right-half .elem6',{opacity:0,scale:0.5,duration:1},'stage3+=11')
