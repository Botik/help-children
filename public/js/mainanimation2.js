$(document).ready(function(){
    if ($(window).width() > 768) {
        ...
        .fromTo('.fixed-animation-block .right-half .empty-cart.with-cont .img-block',{height:'44rem'},{height:'30rem',duration:1},'stage2+=4')
        ...
        .fromTo('.empty-cart.with-cont .progress-list .progress-bar.bar1',{width:0,flex:'initial'},{width:'100%',duration:0.5},'stage2+=4.5')
        .fromTo('.empty-cart.with-cont .progress-list',{opacity:0},{opacity:1,duration:0.5},'stage2+=4.5')
        .fromTo('.empty-cart.with-cont .amount-block',{opacity:0},{opacity:1,duration:0.5},'stage2+=5')
        .fromTo('.empty-cart.with-cont .needed-block',{opacity:0},{opacity:1,duration:0.5},'stage2+=5.5')
        .fromTo('.empty-cart.with-cont .want-help-button',{opacity:0},{opacity:1,duration:0.01},'stage2+=6')
        .fromTo('.empty-cart.with-cont .want-help-button',{scale:1},{scale:0.8,duration:0.2},'stage2+=6')
        .fromTo('.empty-cart.with-cont .want-help-button',{scale:0.8},{scale:1,duration:0.2},'stage2+=6.2')
        .to('.fixed-animation-block .list_item:nth-child(2) .subinfo',{opacity:0,duration:1},'stage2+=8.7')
        .to('.fixed-animation-block .list_item:nth-child(2)',{background:'#FCFAF5',duration:1},'stage2+=8.7')
        .to('.fixed-animation-block .list_item:nth-child(2) .romb',{background:'#FCFAF5',duration:1},'stage2+=8.7')
        .to('.fixed-animation-block .list_item:nth-child(2)',{background:'transparent',duration:0},'stage2+=9.7')
        .to('.fixed-animation-block .list_item:nth-child(2) .romb',{background:'transparent',duration:0},'stage2+=9.7')
        .to('.fixed-animation-block .list .line',{height:'70px',duration:0},'stage2+=9.7')
        .to('.fixed-animation-block .list_item:nth-child(2) .text',{color:'#000000',duration:1},'stage2+=8.7')
        .to('.fixed-animation-block .list_item:nth-child(2) .text',{duration:1.5},'stage2+=9.7')
        // Третий пункт
        ...
        .to('.fixed-animation-block .list .line',{height:'140px',duration:0},'stage3+=16.5')
        ...
        .to('.fixed-animation-block .list_item:nth-child(4) .subinfo',{opacity:1,duration:0.5},'stage4+=4')
...
// stage4 +=2
        ...
        .to('.fixed-animation-block .list .line',{height:'210px',duration:0},'stage4+=7')
        ...
        .to('.fixed-animation-block .list .line',{height:'280px',duration:0})
        .to('.fixed-animation-block .list_item:nth-child(5) .text',{color:'#000000',duration:1},'-=1')
