$(document).ready(function(){
    if ($(window).width() > 768) {
        ...
        .fromTo('.empty-cart.with-cont .want-help-button',{scale:1},{scale:0.8,duration:0.2},'stage2+=5.5')
        .fromTo('.empty-cart.with-cont .want-help-button',{scale:0.8},{scale:1,duration:0.2},'stage2+=5.7')
        .to('.fixed-animation-block .list_item:nth-child(2) .subinfo',{opacity:0,duration:1},'stage2+=8.2')
        .to('.fixed-animation-block .list_item:nth-child(2)',{background:'#FCFAF5',duration:1},'stage2+=8.2')
        .to('.fixed-animation-block .list_item:nth-child(2) .romb',{background:'#FCFAF5',duration:1},'stage2+=8.2')
...
// stage4 +=2
        ...
        .to('.empty-cart.with-cont .GMFCS',{padding:'1rem 3.66rem',
