$(document).ready(function(){
    if ($(window).width() > 768) {
        ...
        .fromTo('.fixed-animation-block .right-half .empty-cart.second',{x:'-30px',y:'-30px'},{x:'0',y:'0',duration:0.5},'stage1+=7.6')
        .fromTo('.fixed-animation-block .right-half .empty-cart.third',{x:'-60px',y:'-60px'},{x:'-30px',y:'-30px',opacity:1,duration:0.5},'stage1+=7.7')
        .fromTo('.fixed-animation-block .right-half .empty-cart.fourth',{x:'-90px',y:'-90px'},{x:'-60px',y:'-60px',opacity:0.78,duration:0.5},'stage1+=7.8')
        .fromTo('.fixed-animation-block .right-half .empty-cart.fiveth',{opacity:0},{opacity:0.7,duration:0.5},'stage1+=7.9')
        ...
        .fromTo('.empty-cart.with-cont .progress-list .progress-bar.bar1',{width:0,flex:'initial'},{width:'100%',duration:0.5},'stage2+=6')
        .fromTo('.empty-cart.with-cont .progress-list',{opacity:0},{opacity:1,duration:0.5},'stage2+=6')
        .fromTo('.empty-cart.with-cont .amount-block',{opacity:0},{opacity:1,duration:0.5},'stage2+=6.5')
        .fromTo('.empty-cart.with-cont .needed-block',{opacity:0},{opacity:1,duration:0.5},'stage2+=7')
        .fromTo('.empty-cart.with-cont .want-help-button',{opacity:0},{opacity:1,duration:0.01},'stage2+=7.5')
        .fromTo('.empty-cart.with-cont .want-help-button',{scale:1},{scale:0.8,duration:0.2},'stage2+=7.5')
        .fromTo('.empty-cart.with-cont .want-help-button',{scale:0.8},{scale:1,duration:0.2},'stage2+=7.7')
        .to('.fixed-animation-block .list_item:nth-child(2) .subinfo',{opacity:0,duration:1},'stage2+=11.2')
        .to('.fixed-animation-block .list_item:nth-child(2)',{background:'#FCFAF5',duration:1},'stage2+=11.2')
        .to('.fixed-animation-block .list_item:nth-child(2) .romb',{background:'#FCFAF5',duration:1},'stage2+=11.2')
        .to('.fixed-animation-block .list_item:nth-child(2)',{background:'transparent',duration:0},'stage2+=12.2')
        .to('.fixed-animation-block .list_item:nth-child(2) .romb',{background:'transparent',duration:0},'stage2+=12.2')
        .to('.fixed-animation-block .list .line',{height:'70px',duration:1},'stage2+=12.2')
        .to('.fixed-animation-block .list_item:nth-child(2) .text',{color:'#000000',duration:1},'stage2+=11.2')
        ...
        .fromTo('.fixed-animation-block .right-half .elem6',{opacity:0,scale:0.5},{opacity:1,scale:1,duration:1},'stage3+=4.5')
        .to('.fixed-animation-block .right-half .elem6',{opacity:0,scale:0.5,duration:1},'stage3+=6')
        .fromTo('.fixed-animation-block .right-half .elem7',{opacity:0,scale:0.5},{opacity:1,scale:1,duration:1},'stage3+=5')
        .to('.fixed-animation-block .right-half .elem7',{opacity:0,scale:0.5,duration:1},'stage3+=6.5')
        .fromTo('.fixed-animation-block .right-half .elem8',{opacity:0,scale:0.5},{opacity:1,scale:1,duration:1},'stage3+=5.5')
        .to('.fixed-animation-block .right-half .elem8',{opacity:0,scale:0.5,duration:1},'stage3+=7')
        .fromTo('.fixed-animation-block .right-half .elem9',{opacity:0,scale:0.5},{opacity:1,scale:1,duration:1},'stage3+=6')
        .to('.fixed-animation-block .right-half .elem9',{opacity:0,scale:0.5,duration:1},'stage3+=7.5')
        .fromTo('.fixed-animation-block .right-half .elem10',{opacity:0,scale:0.5},{opacity:1,scale:1,duration:1},'stage3+=6.5')
        .to('.fixed-animation-block .right-half .elem10',{opacity:0,scale:0.5,duration:1},'stage3+=8')

        .fromTo('.fixed-animation-block .right-half .elem2',{opacity:0,scale:0.5},{opacity:1,scale:1,duration:1},'stage3+=7')
        .to('.fixed-animation-block .right-half .elem2',{opacity:0,scale:0.5,duration:1},'stage3+=8.5')
        .fromTo('.fixed-animation-block .right-half .elem3',{opacity:0,scale:0.5},{opacity:1,scale:1,duration:1},'stage3+=7.5')
        .to('.fixed-animation-block .right-half .elem3',{opacity:0,scale:0.5,duration:1},'stage3+=9')
        // .fromTo('.fixed-animation-block .right-half .elem4',{opacity:0,scale:0.5},{opacity:1,scale:1,duration:1},'stage3+=8')
        ...
        .to('.fixed-animation-block .right-half .empty-cart.with-cont .reabilitation-block',{opacity:0,duration:0.5},'stage3+=13.5')
...
// stage4 +=2
        ...
        .fromTo('.fixed-animation-block .right-half .elem6',{opacity:0,scale:0.5},{opacity:1,scale:1,duration:1},'stage6+=5')
        .to('.fixed-animation-block .right-half .elem6',{opacity:0,scale:0.5,duration:1},'stage6+=6.5')
        .fromTo('.fixed-animation-block .right-half .elem7',{opacity:0,scale:0.5},{opacity:1,scale:1,duration:1},'stage6+=5.5')
        .to('.fixed-animation-block .right-half .elem7',{opacity:0,scale:0.5,duration:1},'stage6+=7')
        .fromTo('.fixed-animation-block .right-half .elem8',{opacity:0,scale:0.5},{opacity:1,scale:1,duration:1},'stage6+=6')
        .to('.fixed-animation-block .right-half .elem8',{opacity:0,scale:0.5,duration:1},'stage6+=7.5')
        .fromTo('.fixed-animation-block .right-half .elem9',{opacity:0,scale:0.5},{opacity:1,scale:1,duration:1},'stage6+=6.5')
        .to('.fixed-animation-block .right-half .elem9',{opacity:0,scale:0.5,duration:1},'stage6+=8')
        .fromTo('.fixed-animation-block .right-half .elem10',{opacity:0,scale:0.5},{opacity:1,scale:1,duration:1},'stage6+=7')
        .to('.fixed-animation-block .right-half .elem10',{opacity:0,scale:0.5,duration:1},'stage6+=8.5')
